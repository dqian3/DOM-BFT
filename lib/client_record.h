...
void getClientRecordsFromProto(
    const google::protobuf::RepeatedPtrField<proto::CheckpointClientRecord> &records,
...
template <typename MessageType> bool verifyRecordDigestFromProto(const MessageType &message)
{
