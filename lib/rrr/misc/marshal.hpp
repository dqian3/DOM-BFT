...
class Marshal : public NoCopy {
    ...
    public:
        ...
        chunk *shared_copy() const { return new chunk(data, read_idx, write_idx); }
...
{
    rrr_verify(m.write(&v, sizeof(v)) == sizeof(v));
    return m;
}
...
inline rrr::Marshal &operator<<(rrr::Marshal &m, const rrr::v32 &v)
{
    ...
    rrr_verify(m.write(buf, bsize) == bsize);
    return m;
}
...
{
    rrr_verify(m.write(&u, sizeof(u)) == sizeof(u));
    return m;
}
...
inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::string &v)
{
    ...
    m << v_len;
    if (v_len.get() > 0) {
        rrr_verify(m.write(v.c_str(), v_len.get()) == (size_t) v_len.get());
    }
    return m;
}

template <class T1, class T2> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::pair<T1, T2> &v)
{
    m << v.first;
    m << v.second;
    return m;
...
template <class T> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::vector<T> &v)
{
    v64 v_len = v.size();
    m << v_len;
...
template <class T> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::list<T> &v)
{
    v64 v_len = v.size();
    m << v_len;
...
template <class T> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::set<T> &v)
{
    v64 v_len = v.size();
    m << v_len;
...
template <class K, class V> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::map<K, V> &v)
{
    v64 v_len = v.size();
    m << v_len;
...
template <class T> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::unordered_set<T> &v)
{
    v64 v_len = v.size();
    m << v_len;
...
template <class K, class V> inline rrr::Marshal &operator<<(rrr::Marshal &m, const std::unordered_map<K, V> &v)
{
    v64 v_len = v.size();
    m << v_len;
...
{
    rrr_verify(m.read(&v, sizeof(v)) == sizeof(v));
    return m;
}
...
{
    char byte0;
    rrr_verify(m.peek(&byte0, 1) == 1);
    size_t bsize = rrr::SparseInt::buf_size(byte0);
    char buf[5];
    rrr_verify(m.read(buf, bsize) == bsize);
...
{
    rrr_verify(m.read(&u, sizeof(u)) == sizeof(u));
    return m;
}
...
inline rrr::Marshal &operator>>(rrr::Marshal &m, std::string &v)
{
    ...
    v.resize(v_len.get());
    if (v_len.get() > 0) {
        rrr_verify(m.read(&v[0], v_len.get()) == (size_t) v_len.get());
    }
    return m;
}

template <class T1, class T2> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::pair<T1, T2> &v)
{
    m >> v.first;
    m >> v.second;
    return m;
...
template <class T> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::vector<T> &v)
{
    v64 v_len;
    m >> v_len;
    v.clear();
...
template <class T> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::list<T> &v)
{
    v64 v_len;
    m >> v_len;
    v.clear();
...
template <class T> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::set<T> &v)
{
    v64 v_len;
    m >> v_len;
    v.clear();
...
template <class K, class V> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::map<K, V> &v)
{
    v64 v_len;
    m >> v_len;
    v.clear();
...
template <class T> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::unordered_set<T> &v)
{
    v64 v_len;
    m >> v_len;
    v.clear();
...
template <class K, class V> inline rrr::Marshal &operator>>(rrr::Marshal &m, std::unordered_map<K, V> &v)
{
    v64 v_len;
    m >> v_len;
    v.clear();
