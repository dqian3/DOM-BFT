...
Scheduler *Scheduler::CurrentScheduler() { return &coro_sched_; }

void Scheduler::AddReadyEvent(Event *ev) { ready_events_.push_back(ev); }
...
void Scheduler::ReturnCoroutine(Coroutine *coro) { delete coro; }
