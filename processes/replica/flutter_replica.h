...
private:
    ...
    void broadcastObserve(const dombft::proto::ClientRequest& request, uint64_t bet);
    void processObserve(uint32_t senderId, const dombft::proto::ClientRequest& request, uint64_t bet);

    // Candidate management
    void initializeCandidate(const dombft::proto::ClientRequest& request, uint64_t bet);
