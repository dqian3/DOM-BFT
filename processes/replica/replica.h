...
namespace dombft
{
    ...
    private:
        ...
        /** The replica uses this endpoint to receive requests from proxies and reply with OWD measurements*/
        SignedUDPEndpoint *endpoint_;

        /** The replica optionally uses this endpoint to forward messages along IPC to the replica*/
